...
First Attempt: Individual useState hooks - became unmanageable

Second Attempt: useReducer - complexity remained high

Final Solution: Custom hook useFileUpload with React context
